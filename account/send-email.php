        ...
        <tr>
            <td align='center'>
                <table border='0' align='center' width='590' cellpadding='0' cellspacing='0' class='container590'>
                    ...
                    <tr>
                        <td align='center'
                            style='color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif !important; font-weight:700;letter-spacing: 3px; line-height: 35px;'
                            class='main-header'>
                            <!-- section text ======-->

                            <div style='line-height: 35px'>

                                Bem vindo a <span style='color: #f37920;'>
                                    NOME</span>
                    ...
                    <tr>
                        <td align='left'>
                            <table border='0' width='590' align='center' cellpadding='0' cellspacing='0'
                                class='container590'>
                                <tr>
                                    <td align='left' style='color: #888888; font-size: 16px; font-family: ' Work Sans',
                                        Calibri, sans-serif; line-height: 24px;'>
                                        <!-- section text ======-->

                                        <p
                                            style='line-height: 24px; margin-bottom:15px; color: #f37920; font-size: 18px;'>

                                            NOME,

                                        </p>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                            Você escolheu o lugar certo para comprar seu seminovo.
                                        </p>
                                ...
                                <tr>
                                    <td>
                                        <table border='0' width='300' align='left' cellpadding='0' cellspacing='0'
                                            ...
                                            <tr>
                                                <td align='left' style='color: #888888; font-size: 14px; font-family: '
                                                    Work Sans', Calibri, sans-serif; line-height: 23px;'
                                                    class='text_color'>
                                                    <div style='color: #333333; font-size: 14px; font-family: ' Work
                                                        Sans', Calibri, sans-serif; font-weight: 600;
                                                        mso-line-height-rule: exactly; line-height: 23px;'>
...
$to =  $email;
$subject = " | Contato recebido com sucesso";
$message = $corpoEmail;
...
$from = "test@hostinger-tutorials.com";
$to =  $email;
$subject = $row->nome . " | Contato recebido com sucesso";
$message = $corpoEmail;
$headers =  'Content-Type: text/html; charset="utf-8"';
mail($to, $subject, $message, $headers);
*/
